...
enum Reminders {
    private static let identifier = "kindcue.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Your daily kindness cue is here"
        content.body = "A small act of kindness keeps your streak alive."
